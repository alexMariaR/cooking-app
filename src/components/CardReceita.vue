<script lang="ts">
import type IReceita from 'src/interfaces/IReceita.ts';
...
<template>
  <article class="receita">
    <header class="receita__cabecalho">
      <img class="receita__imagem" :src="`/Users/alessandrasilva/my-cooking-app/public/imagens/receitas${receita.imagem}`" :alt="`Foto de ${receita.nome}`">
    </header>
